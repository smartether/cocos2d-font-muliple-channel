...
plugin render font packed in muliple channel for cocos2dx. Implement BMFont and enhance the CCLabelBMFont in cocos2dx. Support pack into multiple option in BMFont.
